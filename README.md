...
> `budget.maybeit.work` (ezBookkeeping), both on vps01, and centralised
> logs (OpenObserve on vps02), whose Cloudflare and node-side setup is
> still being rolled out. ezBookkeeping is
